  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Experience seamless rides with Car Sharing Application - your gateway to a world of convenient and eco-friendly travel solutions."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience seamless rides with Car Sharing Application - your gateway to a world of convenient and eco-friendly travel solutions.`}
            </Text>
            <Box
